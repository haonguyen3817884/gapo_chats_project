...
class Constants {
  ...
  static String apiLoginBase = "https://staging-api.gapowork.vn/";
  static String apiChatBase = "https://staging-messenger.gapowork.vn/";
  ...
  static String customerLogin = "auth/v3.0/login";
  static String customerInfo = "user-profile/v1.0/profile";

  static String getChats = "chat/v3.3/threads";
